...
var View = (function () {
    function View() {
        ...
        this.$pauseBtn = $('.js-game__button-pause').get(0);
        this.$clearBtn = $('.js-game__button-clear').get(0);
        this.$widthInput = $('.js-game__input-width').get(0);
...
var map = {
	"./Controller/BoardController.ts": 0,
	"./Model/Board.ts": 1,
	"./Polyfill/Array/fill/fill.ts": 2,
	"./View/View.ts": 3,
	"./main.ts": 7,
	"./style.styl": 5
};
